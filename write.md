...
<title>www.StarComputer.Space | Welcome STAR Teknoloji WEB Alanı</title>
<meta name="generator" content="Jekyll v3.9.3">
<meta property="og:title" content="Web.StarComputer.Space">
<meta property="og:locale" content="en_US">
<meta name="description" content="Welcome STAR Teknoloji WEB Alanı">
<meta property="og:description" content="Welcome STAR Teknoloji WEB Alanı">
<link rel="canonical" href="http://web.starcomputer.space/">
<meta property="og:url" content="http://web.starcomputer.space/">
<meta property="og:site_name" content="Web.StarComputer.Space">
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary">
<meta property="twitter:title" content="Web.StarComputer.Space">
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebSite","description":"Welcome STAR Teknoloji WEB Alanı","headline":"Web.StarComputer.Space","name":"Web.StarComputer.Space","url":"http://web.starcomputer.space/"}</script>
<!-- End Jekyll SEO tag -->


    <link rel="stylesheet" href="./style(2).css">
    <script src="./scale.fix.js.indir"></script>
...
<!-- end custom head snippets -->
  ...
  <body>
    <div class="wrapper">
      <header>
        <h1>Web.StarComputer.Space</h1>
        
          <p>Welcome STAR Teknoloji WEB Alanı</p>
        
        <p class="view"><a href="https://github.com/StarTeknoloji/Web.StarComputer.Space">View the Project on GitHub <small></small></a></p>
        <ul>
        
          <li><a href="https://github.com/StarTeknoloji/Web.StarComputer.Space">View On <strong>GitHub</strong></a></li>
        </ul>
      </header>
      <section>
    ...
    <link rel="stylesheet" href="./style(3).css" media="screen" type="text/css">
    ...
    <div id="content-wrapper">
      <div class="inner clearfix">
        <section id="main-content">
          <ul>
  <li><strong><em>[</em></strong><code class="language-plaintext highlighter-rouge">**</code><code class="language-plaintext highlighter-rouge">Star</code><code class="language-plaintext highlighter-rouge">My</code>Tech<code class="language-plaintext highlighter-rouge">**</code><strong><em>]</em></strong><img src="./226168678-ad897552-4ee9-4605-a699-d07bb4da0f08.png" alt="205482173-eb192a78-eb2b-4d31-8c1e-d722f6741c28 123 3"><strong>*
 <img src="./234849608-2d348961-071f-48e6-a707-674f672f6006.png" alt="ekran görüntüsü2">
...
***</code>é<code class="language-plaintext highlighter-rouge">**©**</code></em><code class="language-plaintext highlighter-rouge">**</code><strong><em><code class="language-plaintext highlighter-rouge">****</code></em></strong><strong><code class="language-plaintext highlighter-rouge">****</code></strong><em><code class="language-plaintext highlighter-rouge">**</code></em><code class="language-plaintext highlighter-rouge">*©*</code><em><code class="language-plaintext highlighter-rouge">**</code></em><strong><code class="language-plaintext highlighter-rouge">****</code></strong><strong><em><code class="language-plaintext highlighter-rouge">****</code></em></strong><code class="language-plaintext highlighter-rouge">**</code><em><code class="language-plaintext highlighter-rouge">**©**</code>é`</em><strong>]</strong>*</li>
  ...
  <li><strong><em><a href="https://github.com/marketplace/netci-netstarspace/upgrade/1/CUSTOMER_ACCOUNT_ID"><code class="language-plaintext highlighter-rouge">NetCI Uygulamamız Yayında NetSTARspace Uygulamamıza Ulaşabilirsiniz</code></a></em></strong>
    <blockquote>
      <p><img src="./196638572-06d9aee1-aaac-4f76-9c90-51efaf6f3ecc.jpg" alt="311.space363061_441927604750503_40249331217705373_n"><img src="./197540001-4a7ce272-e92e-4f67-b6c4-76d8613d2745.png" alt="indir (7)">
<a href="https://github.com/StarTeknoloji/httpsSTARteknoloji.Space/actions/workflows/codacy.yml"><img src="./badge.svg" alt="Codacy Security Scan"></a>
<a href="https://github.com/StarTeknoloji/httpsSTARteknoloji.Space/actions/workflows/pages/pages-build-deployment"><img src="./badge(1).svg" alt="pages-build-deployment"></a>
 <a href="https://github.com/StarTeknoloji/httpsSTARteknoloji.Space/actions/workflows/main.yml"><img src="./badge(2).svg" alt="CI"></a>
<a href="https://github.com/StarTeknoloji/httpsSTARteknoloji.Space/actions/workflows/starteknoloji.yml"><img src="./badge(3).svg" alt="CI"></a></p>
    </blockquote>
  </li>
</ul>
<iframe width="760px" height="500px" src="./embed(5).html" frameborder="0" marginheight="0" marginwidth="0" max-width="100%" sandbox="allow-forms allow-modals allow-orientation-lock allow-popups allow-same-origin allow-scripts" scrolling="no" style="border: none; max-width: 100%; max-height: 100vh" allowfullscreen="" mozallowfullscreen="" msallowfullscreen="" webkitallowfullscreen=""></iframe>

<iframe src="./saved_resource(15).html" title="StarTeknoloji.space" height="400" width="650" style="border: 0;"></iframe>

<iframe src="./saved_resource(16).html" title="Planet" height="400" width="650" style="border: 0;"></iframe>

<iframe src="./saved_resource(17).html" title="Planet" height="400" width="650" style="border: 0;"></iframe>
...
<iframe src="./widget(5).html" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
<iframe src="./card(10).html" title="Sponsor StarTeknoloji" height="225" width="600" style="border: 0;"></iframe>
<iframe src="./card(11).html" title="Sponsor Codes-Exe" height="225" width="600" style="border: 0;"></iframe>

<blockquote>
  <blockquote>
    <p><img src="./205449344-6e2ae0d7-ac8a-45af-8f20-a01645003ecd.png" alt="13369547_transparent (4)">
<img src="./9dc564fc-3358-4e72-8ede-92118f2c6da3" alt="rotating_knot"></p>
  </blockquote>
</blockquote>

<h2 id="this-is-an-emerging-platform"><strong><em>This is an Emerging Platform</em></strong></h2>
<h2 id="please-contribute"><strong><em>Please Contribute</em></strong><img src="./33f1467c-6939-4793-8866-2ae63b79650d" alt="unnamed2"></h2>
